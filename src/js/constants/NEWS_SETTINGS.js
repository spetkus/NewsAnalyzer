...
const COUNT_RENDER_NEWS = 3;

const BUTTON_NEXT_NEWS = document.querySelector(".news__button");

export { NEWS_API_SETTINGS, DATES, ERROR_MESSAGE, FORM_SEARCH_NEWS, RESULT_BLOCKS, RESULT_ERROR_MESSAGE, NEWS_LIST, COUNT_RENDER_NEWS, BUTTON_NEXT_NEWS };